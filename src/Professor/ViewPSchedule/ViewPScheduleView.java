...
public class ViewPScheduleView extends JFrame{
	...
	public void addJTable(String[][] data){
		String[] columns = {"CourseName","CourseDates","CourseTime"};
	...
	public void addGetPScheduleListener(ActionListener listenForGetSchedule){
